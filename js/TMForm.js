	...
	$.fn.TMForm=function(opt){
		...
		function TMForm(){
			...
			function formSubmit(){
				...
				elements_to_validate = $('[data-constraints]',form)

				for (var i = elements_to_validate.length - 1; i >= 0; i--) {
					if (delete_validation_list.includes(elements_to_validate[i].id))
						{
							elements_to_validate.splice(i, 1);
						}
				}

				elements_to_validate.trigger('validate.form')
